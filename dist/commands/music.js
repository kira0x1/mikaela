...
var subcmd = [
    ...
    },
    {
        ...
        execute: function (message, args) {
            return __awaiter(this, void 0, void 0, function () {
                var currentSong, embed;
                return __generator(this, function (_a) {
                    currentSong = exports.player.queue.currentSong;
                    if (!currentSong)
                        return [2 /*return*/, Style_1.QuickEmbed("No song currently playing")];
    ...
    execute: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                query = args.join();
                if (query === "")
                    return [2 /*return*/, Style_1.QuickEmbed("" + config_1.prefix + this.usage)];
