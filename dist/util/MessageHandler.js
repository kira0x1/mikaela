...
function OnMessage(message) {
    return __awaiter(this, void 0, void 0, function () {
        var args, cname, command, hasPerms;
        return __generator(this, function (_a) {
            ...
            cname = (args.shift() || "none").toLowerCase();
            if (cname.startsWith(config_1.prefix) || cname === "none")
                return [2 /*return*/];
            command = CommandUtil_1.CommandUtil.GetCommand(cname);
            if (command === undefined)
                return [2 /*return*/, Style_1.QuickEmbed("Command **" + cname + "** not found")];
            if (command.args && !args.length) {
                // Check if args is required
                return [2 /*return*/, Send(Style_1.darken("" + config_1.prefix + command.name, command.usage || ""))];
            }
            hasPerms = true;
            if (command.perms) {
