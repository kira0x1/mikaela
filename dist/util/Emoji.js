...
var ms = require("ms");
var reactionDuration = ms("5m");
//Emojis in collection
var emojis = new discord_js_1.Collection();
exports.sweat = "😰";
function init(client) {
    client.emojis.map(function (emoji) { return emojis.set(emoji.name, emoji); });
}
exports.init = init;
...
function FavoritesHandler(message, emojiName, song) {
    return __awaiter(this, void 0, void 0, function () {
        var emoji, filter, collector;
        var _this = this;
        return __generator(this, function (_a) {
            emoji = getEmoji(emojiName);
            if (!emoji)
                return [2 /*return*/, console.error("Emoji not found")];
            filter = function (reaction, user) {
                return reaction.emoji.name === emoji.name && !user.bot;
            };
            message.react(emoji);
            collector = message.createReactionCollector(filter, { time: reactionDuration });
            collector.on("collect", function (reaction, reactionCollector) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    dbFavorites_1.AddUserSong({ tag: user.tag, id: user.id, nickname: user.username }, song);
                    return [2 /*return*/];
                });
            }); });
