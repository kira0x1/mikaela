...
exports.queueCalls = new discord_js_1.Collection();
exports.command = {
    name: "Queue",
    ...
    execute: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            var embed, lastQueueCall;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        embed = getQueue(message);
                        return [4 /*yield*/, message.channel.send(embed)];
                    case 1:
                        lastQueueCall = _a.sent();
                        if (lastQueueCall instanceof discord_js_1.Message) {
                            exports.queueCalls.set(message.author.id, lastQueueCall);
                        }
                        return [2 /*return*/];
                }
            });
...
function getQueue(message) {
    ...
    for (var i = 0; i < player.queue.songs.length && i < 25; i++) {
        var song = player.queue.songs[i];
