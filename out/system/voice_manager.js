...
function initVoiceManager(client) {
    return __awaiter(this, void 0, void 0, function () {
        var coders_club, voice_role;
        return __generator(this, function (_a) {
            coders_club = client.guilds.get(config_1.coders_club_id);
            if (!coders_club)
                return [2 /*return*/];
            voice_role = coders_club.roles.get("642540366935097365");
            if (!voice_role)
                return [2 /*return*/];
            coders_club.members.map(function (m) {
                if (m.roles.has(voice_role.id)) {
                    m.removeRole(voice_role);
                }
            });
            coders_club.channels.map(function (channel) {
...
exports.initVoiceManager = initVoiceManager;
