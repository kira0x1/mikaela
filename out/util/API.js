...
var musicUtil_1 = require("./musicUtil");
var ytdl_core_1 = require("ytdl-core");
var ytdl_core_2 = __importDefault(require("ytdl-core"));
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ytdl_core_2.default.getInfo(query).then(function (info) {
                        var songResult = {
                            title: info.title,
                            id: info.video_id,
                            url: info.video_url,
                            duration: musicUtil_1.ConvertDuration(info.length_seconds)
                        };
                        return resolve(songResult);
                    }).catch(function (err) {
                        Youtube.Get(query).then(function (songResult) {
                            if (songResult)
                                return resolve(songResult);
                            else {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request_promise_1.default(url).then(function (data) {
                            ...
                            }).catch(function (err) { return console.log("couldnt find id"); })];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        song = {
                            ...
                            url: res.video_url,
                            id: id,
                            duration: musicUtil_1.ConvertDuration(res.length_seconds)
                        };
                        _a.label = 3;
